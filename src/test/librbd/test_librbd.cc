...
TEST_F(TestLibRBD, TestDataPoolIO)
{
  ...
  std::string orig_data_pool_name;
  ASSERT_EQ(0, _rados.conf_get("rbd_default_data_pool", orig_data_pool_name));
  ASSERT_EQ(0, _rados.conf_set("rbd_default_data_pool",
                               data_pool_name.c_str()));
  BOOST_SCOPE_EXIT( (orig_data_pool_name) ) {
    ASSERT_EQ(0, _rados.conf_set("rbd_default_data_pool",
                                 orig_data_pool_name.c_str()));
